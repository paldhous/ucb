...
```
- `ridgecrest_quakes.csv` Earthquakes larger than magnitude 2.5 in a bounding box including Ridgecrest, California, from June 20 to July 6, 2019. Type this url into the address bar of your browser:
- ```Javascript
