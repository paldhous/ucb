...
For this week's geocoding exercise, you will need a Bing Maps API key and a MapQuest API key. Obtain your MapQuest key from [here](https://developer.mapquest.com/).
