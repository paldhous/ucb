...
####data
- disease_democ
- baseball (update, from R Lehman package)
...
####data
- nations (update, remove life expectancy)
...
####data
To illustrate url manipulation and scrape
- http://www.isrctn.com/search?pageSize=1000&sort=&page=1&q=&filters=condition%3Abreast+cancer&searchType=advanced-search
Show how to create

API manipulation
- http://earthquake.usgs.gov/fdsnws/event/1/query.geojson?starttime=1901-01-01%2000:00:00&latitude=39&longitude=-98&maxradiuskm=6000&minmagnitude=6&endtime=2015-08-14%2023:59:59&orderby=time-asc

To illustrate data cleaning
...
- ####**Sept. 24:** [**Interviewing data: using databases**](week6.html)
...
- doctors and fda
- also show how tableau can do joins


- ####**Oct. 1:** [Let's apply what we've learned so far](week5.html)
...
- ####**Oct. 15:** [**Making static maps and processing geodata with GIS software**](week9.html)
...
-  ####**Oct. 22:** [**Making interactive maps; processing geodata with SQL**](week8.html)
